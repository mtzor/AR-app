...
public class LobbyUI : MonoBehaviour {
    ...
    private void Awake() {
        ...
        changeExperButton.OnClicked.AddListener(() => {
            LobbyManager.Instance.UpdatePlayerCharacter(LobbyManager.PlayerType.Expert);
        });
        changeNonExpertButton.OnClicked.AddListener(() => {
            LobbyManager.Instance.UpdatePlayerCharacter(LobbyManager.PlayerType.NonExpert);
        });
